        ...
        <div className="exp_content">
          ...
          <div className="exp_checkmeout">
            ...
            <div className="exp_checkme_icons">
              ...
              <div className="linkedin_icon_container"  onClick={()=>window.open("https://www.linkedin.com/in/divesh-3327a0a7/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3B3CBzAbnDRdOVT1xjYy%2FMvg%3D%3D", '_blank')}>
                <i class="fab fa-linkedin-in"></i>
              </div>
              <div className="behance_container_postition"  onClick={()=>window.open("https://www.behance.net/divesh", '_blank')}>
                <i class="fab fa-behance"></i>
              </div>
              <div  className="behance_container_postition"  onClick={()=>window.open("https://twitter.com/divesh29562085", '_blank')}>
